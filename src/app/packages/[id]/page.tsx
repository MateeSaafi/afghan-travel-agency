...
import { ArrowLeft, Clock, Tag, FileText, CheckCircle2, Loader2 } from "lucide-react";
  ...
  if (error || !item) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        <h1 className="text-2xl font-bold text-zinc-100 mb-2">Package Not Found</h1>
        <p className="text-zinc-400 mb-4">The package you're looking for doesn't exist.</p>
        <Link
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-4">
              <div className="relative aspect-[4/3] overflow-hidden rounded-lg border border-zinc-800 bg-zinc-900 shadow-[0_0_50px_rgba(251,146,60,0.06)]">
                <Image
                  src={item.image}
                  alt={item.name}
                  fill
            ...
            <div className="space-y-6">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-orange-400">${item.price}</p>
                </div>
              ...
              {/* Description */}
              <div>
                <h2 className="text-lg font-semibold text-zinc-100 mb-2">Description</h2>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-5">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-lg font-semibold text-zinc-100">Required Documents</h2>
                </div>
              ...
              {/* Appointment Form */}
              <AppointmentForm itemId={item.id} itemName={item.name} />
            </div>
          </div>
        </div>
      </main>
